...
#gitlink is no longer available on cran, therefore installing older version:

install.packages("remotes")  # if not already installed
remotes::install_version("gitlink", version = "0.1.0")  # replace with the version you need
